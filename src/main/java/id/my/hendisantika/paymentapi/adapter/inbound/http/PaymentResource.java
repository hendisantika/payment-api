...
public class PaymentResource {
    ...
    public ResponseEntity<String> createPayment(@RequestBody PaymentDto paymentDto) {
        //This API is only to receive the payment request and publish the event, the actual processing of the payment will be done by another service that will consume the event from Kafka.
